'use client';
  ...
  const EditarPaquete: React.FC<EditarPaqueteProps> = ({
    title,
    paquete,
    currentUser,
    onClose,
    ...
    const { 
      ...
      defaultValues: {
        ...
        paqAncho: paquete.paqAncho,
        paqLargo: paquete.paqLargo,
        paqAlto: paquete.paqAlto,
        paqPeso: paquete.paqPeso,
        paqContenido: paquete.paqContenido,
        paqTipoId: paquete.paqTipoId,
        paqPesoVol: paquete.paqPesoVol,
        paqEmpaqueId: paquete.paqEmpaqueId,
      },
    });
    ...
    async (data) => {
      ...
      const closeData = {action: 'save', id: paquete.id, data: changedData}
                ...
                <div className="flex flex-row items-end">
                  <div className="w-28  pr-2">
                    <Input
                      ...
                      required
                      onChange={(event: any) => {
                        setCustomValue('paqAncho',parseFloat(event.target.value));
                      }}
                      onFocus={() => {
                ...
                <div className="flex flex-row items-end">
                  <div className="w-28  pr-2">
                    <Input
                      ...
                      required
                      onChange={(event: any) => {
                        setCustomValue('paqAlto', parseFloat(event.target.value));
                      }}
                      onFocus={() => {
                        setFotoPaq(fotoAlto)
                        setNotas('Las medidas en centímetros')
                ...
                <div className="flex flex-row items-end">
                  <div className="w-28  pr-2">
                    <Input
                      ...
                      required
                      onChange={(event: any) => {
                        setCustomValue('paqLargo', parseFloat(event.target.value));
                      }}
                      onFocus={() => {
                ...
                <div className="flex flex-row items-end">
                  <div className="w-28  pr-2">
                    <Input
                      ...
                      required
                      onChange={(event: any) => {
                        setCustomValue('paqPeso', parseFloat(event.target.value));
