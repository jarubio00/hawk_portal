...
const AgregarDireccion: React.FC<AgregarDireccionProps> = ({
  ...
  const otraColonia = watch("otraColonia");
    ...
    return (
      <div>
        ...
        >
          <div
            className={`${
              otraColoniaSelected ? "col-span-2 md:col-span-1" : "col-span-2"
            }`}
          >
            <Select
              id="colonia"
        ...
        {tipo == "direccion" && (
          <>
            ...
            <div className="my-2">
              <Badge
                className={`cursor-pointer  pr-3 pl-2 py-0 bg-[${nombreColor}]`}
              >
        ...
        <div className="w-40 my-4">
          <Button
            label={from == "pedido" ? "Agregar y usar" : "Agregar dir"}
    ...
    <>
      ...
      <div className="w-full  flex flex-col gap-2   py-2 ">
        ...
        {!cpActive && !coloniasLoading && (
          <div className="flex flex-row items-center content-center my-1 mt-2">
