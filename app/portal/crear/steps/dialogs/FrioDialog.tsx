...
interface FrioDialogProps {
  disabled: boolean;
  onNext: () => void;
}

const FrioDialog: React.FC<FrioDialogProps> = ({
  disabled = false,
  onNext,
}) => {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="bg-[url('/images/avisos/nieve.gif')] bg-blue-100 bg-no-repeat bg-cover">
        <AlertDialogHeader>
          <AlertDialogTitle>AVISO IMPORTANTE</AlertDialogTitle>
          <AlertDialogDescription className="text-black">
            Debido a las bajas temperaturas les informamos que el día martes 21
            de enero, nuestras operaciones podrían verse afectadas.
