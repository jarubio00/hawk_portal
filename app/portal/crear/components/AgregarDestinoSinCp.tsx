        ...
        <div className="w-full  flex flex-col gap-2   py-2 ">
          ...
          <div >
              <div className="
                  ...
                  <div className="col-span-2 md:col-span-2">
                    <Select
                        ...
                        styles={{
                          control: (provided,state) => (errors.municipio ? {
                            ...provided,
                            borderColor: '#f43f5e',
              ...
              {tipo == 'destino' && from == 'pedido' && !saved && <div className="my-2 felx flex-row gap-2 items-center">
                ...
                <span className="text-sm font-semibold text-neutral-700 ml-2">No se puede guardar una dirección sin código postal</span>
              </div>}
