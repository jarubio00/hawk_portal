        ...
        <div className="flex flex-col gap-1 w-full  lg:w-2/4 border border-neutral-300 rounded-lg mt-3">
            <div className="flex flex-row items-center gap-3  justify-between p-3">
                ...
                <div className="flex flex-col items-end">
                    ...
                    <p className="text-xs text-neutral-500 ">{data.recoleccion?.colonia}, {data.recoleccion?.municipio?.municipio}</p>
                </div>
            </div>
            ...
            <div className="flex flex-row items-center gap-3  justify-between p-3">
                ...
                <div className="flex flex-col items-end w-3/5 lg:w-full text-right">
                    ...
                    <p className="text-xs text-neutral-500 ">{data.destino?.colonia}, {data.destino?.municipio?.municipio}</p>
                </div>
            </div>
            <hr className="my-0"></hr>
            <div className="flex flex-row items-center gap-3  justify-between p-3">
                ...
                <div className="flex flex-col items-end w-3/5 lg:w-full text-right">
                    ...
                    <p className="text-xs text-neutral-500 ">{data.paquete?.paqAlto}cm X {data.paquete?.paqAncho}cm X {data.paquete?.paqLargo}cm - ({data.paquete?.paqPeso} Kg)</p>
                    {data.cobro && <p className="text-xs text-blue-500 ">Se cobrarán ${data.cobroCantidad}.00 al destinatario</p>}
                </div>
            </div>
