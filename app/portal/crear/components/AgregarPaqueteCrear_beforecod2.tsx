            ...
            <div className="mt-4">
              {pedido && !pedido?.cobro ? (
                <div className="relative">
                  <Card className="relative w-full md:max-w-[450px] overflow-hidden p-5">
                    <ShineBorder
                      shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]}
                    />
                    <div
                      className="flex flex-row  items-center text-md text-neutral-500  gap-2 cursor-pointer underline"
                      onClick={() => {
                        setResetCobro(false);
                        setCobrosDialogOpen(true);
                      }}
                  ...
                  <div className="absolute -top-2 -left-4 h-6 w-14 ">
