...
import TerminosDialog from "./TerminosDialog";
...
const CobrosDialog: React.FC<CobrosDialogProps> = ({
  ...
  const handleTerminosClose = () => {
    setTerminosOpen(false);
  };

  return (
    <>
      <TerminosDialog isOpen={terminosOpen} onClose={handleTerminosClose} />
            ...
            <div className="flex min-h-full items-center justify-center p-2 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl  m-4 md:m-0 transform  rounded-2xl bg-white p-4 text-left align-middle shadow-xl transition-all ">
                  ...
                  >
                    <span className="ml-2">
                      Cobraremos al destinatario el monto que nos indiques al
                    ...
                    <div>
                      <div className="my-4 w-56 mx-auto flex flex-col">
                        ...
                        <div className="text-xs text-neutral-500  mt-1">
                          Comisión: ${(monto * 0.045).toFixed(2)}
                        </div>
                      </div>
                  ...
                  {confirmarMonto && (
                    <div className="flex flex-row w-full items-center justify-end mt-6 mb-2">
                      <div className="w-24 ml-2">
                        <Button
                          outline
                          label="Cambiar"
