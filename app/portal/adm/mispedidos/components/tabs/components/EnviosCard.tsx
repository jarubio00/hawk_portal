'use client';
import { bloqueToString, dateString, namedDateString, statusIdToString } from "@/app/components/utils/helpers";
          ...
          <div 
            className="w-full  flex flex-row justify-between gap-2  items-center  px-2 py-1"
              ...
              <div className="w-6/12 flex flex-col grow-0 text-left text-xs">
                  ...
                  <p className="text-[11px] text-neutral-500 truncate ">{data.recoleccion.contactoNombre}</p>
              ...
              <div className="w-6/12 flex flex-col items-end text-xs">
                ...
                <p className="text-[11px] text-neutral-500 truncate ">{data.entregaContactoNombre}</p>
                <p className="text-[11px] text-neutral-500 truncate ">{namedDateString(data.fechaEntrega)}</p>
                  ...
                  <p className="text-[11px] text-neutral-500 truncate">{data.entregaColonia}, Monterrey</p>
              </div>
