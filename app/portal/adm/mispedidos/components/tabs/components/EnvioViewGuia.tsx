...
const EnvioViewGuia: React.FC<EnvioViewGuiaProps> = ({ data }) => {
  useEffect(() => {}, []);

  const [image, setImage] = useState();
  const pdfFile = data?.labelPdfUrl
    ? data?.labelPdfUrl
    : "https://pdffiles.com/file.pdf";

  const GuiaDocument = () => guiaDoc(data);
