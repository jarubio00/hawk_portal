...
const ConfirmationStep: React.FC<ConfirmationStepProps> = ({ data }) => {
  ...
  return (
    <div className="m-0">
      ...
      <div className="my-8 w-full flex flex-col justify-center items-center mx-auto">
        ...
        <div className="my-4 w-full">
          <div className="flex flex-row items-center justify-between">
            <p></p>
            {resendTimer && codeValidation != "correcto" && (
              <OtpTimer
      ...
      <Button outline label="Atras" onClick={handleBack} disabled={isLoading} />
      <Button
        label="Siguiente"
        onClick={handleNext}
