  ...
  const data = await prisma.pedido.findUnique({
      ...
      if (data && data.operaciones) {
        ...
        rastreo = {
            ...
            enRutaRec: ops.punteoRecoleccion || ops.recolectado || ops.punteoEntrega || ops.entregado ? true : false,
            enRutaRecAt : ops.punteoRecoleccionAt ? ops.punteoRecoleccionAt : undefined,
            recolectado: ops.recolectado || ops.punteoEntrega || ops.entregado ? true : false,
