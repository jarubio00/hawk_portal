...
-- AddForeignKey
ALTER TABLE `Recolecciones` ADD CONSTRAINT `Recolecciones_estatusRecoleccionId_fkey` FOREIGN KEY (`estatusRecoleccionId`) REFERENCES `CatalogoEstatusRecolecciones`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Recolecciones` ADD CONSTRAINT `Recolecciones_municipioId_fkey` FOREIGN KEY (`municipioId`) REFERENCES `CatalogoMunicipios`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
